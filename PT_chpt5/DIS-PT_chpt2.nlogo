...
;ask patches [
;  set neighborhood patches in-radius vision ; vision is a variable, set for example by rulergg
; ]
;
...
to setup
 ...
 set patch-steps 5
  ...
  ; setup prison
  let prisonpatches patches with [ pxcor >= 1 and pxcor <= 14 and pycor >= 1 and pycor <= 14 ]
    ask prisonpatches [
      set pcolor gray
      set region "prison"
    ]
